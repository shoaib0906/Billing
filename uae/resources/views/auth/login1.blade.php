@extends('layouts.guest')
    ...
    @section('content')
        ...
        <div class="full-content-center animated fadeInDownBig" >
            <a href="/"><img src="{{asset('/assets/img/digital_tc.jpg')}}" class="" alt="Logo"></a>
            <div class="login-wrap">
                <div class="box-info">
                <h2 class="text-center"><strong></strong> Login In Step 1 </h2>
                    
                    <form role="form" action="{!! URL::to('/authenticate') !!}" method="post" class="login-form">
                        {!! csrf_field() !!}
                        <div class="form-group login-input">
                        <i class="fa fa-sign-in overlay"></i>
                        <input type="text" name="username" id="username" value="{{ old('username') }}" class="form-control text-input" placeholder="Username">
                        </div>
                        <div class="form-group login-input">
