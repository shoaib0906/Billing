 ...
 <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color:#34495e;color:white;">
          ...
          <h4 class="modal-title">Estimate Product Update</h4>
        </div>
            ...
            <div class="">
                <div class="">
                  ...
                  <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="{{url('/est_product_edit')}}">
...
<div id="content">
  <div id="content-header">
   <div id="content-header">
        ...
        <a href="#"> <i class="icon-file"></i>Estimate</a>
      ...
      <div class="">
        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
            <h5> <code>Estimate Product Setup </code></h5>
          </div>
          <div class="widget-content ">
            
          </div>
           <form action="{{url('/post_est_product')}}" method="post" class="form-horizontal">
          <div class="widget-content">
      ...
      @if(!empty($product_quote))
       <div class="span8 pull-right">
        <div class="">
          <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
            <h5><code>Estimate Product List</code></h5>
          </div>
          <div class="widget-content nopadding" >
              ...
              <tbody>
                ...
                <td class="taskOptions">{{$product_quote->product_code}}</td>
                  ...
                  <td class="taskOptions">{{$product_quote->warrenty}}</td>
                    ...
                    <!--<a href="{{url("delete-est_pro/$product_quote->id") }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="icon-remove"></i></a>-->
