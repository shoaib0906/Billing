      ...
      <div class="span4">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
            <h5> <code>Estimate {{$order_no}}</code></h5>
          </div>
          <div class="widget-content ">
            <form action="{{url('/add_to_estimate')}}" method="post" class="form-horizontal">
        ...
        <div class="">
          ...
          <div class="widget-content nopadding" >
              ...
              <tbody>
                ...
                <td class="taskOptions">{{$sales->product_code}}</td>
                  ...
                  <?php $total_amount = $total_amount+$sales->sales_price * $sales->quantity ?></td>
                    ...
                    <a href="{{url("delete-estimate/$sales->id") }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="icon-remove"></i></a>
           ...
           <br>
            ...
            <form action="{{url('/generate_estimate')}}" method="post" class="form-horizontal pull-center" 
