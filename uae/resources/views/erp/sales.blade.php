...
<div id="content" ng-app>
  <div id="content-header">
   <div id="content-header">
        ...
        <a href="{{'/product_purchase'}}" class="current"> Sales</a>
      ...
      <div class="span4">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
            <h5> <code>Sales {{$order_no}}</code></h5>
          </div>
          <div class="widget-content ">
            <form action="{{url('/add_to_edit')}}" method="post" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}">
               ...
               <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <input type="text"  class="span12" autocomplete="off" name="product_code" placeholder="Enter Product Code"  autofocus required>
                </div>
              </div>
            
              <div class="control-group">
                <button type="submit" class="pull-right btn btn-success btn-mini">Edit Product</button>
          ...
          <div class="widget-content">
            <form action="{{url('/post_barcode')}}" method="post" class="form-horizontal">
            <input type="hidden" name="_token" value="{{csrf_token()}}">
               ...
               <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <input type="hidden" class="span11" value="{{$order_no}}" name="order_no" placeholder="Enter Supplier Invoice No" />
               ...
               <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <input type="text"  class="span11" value="{{isset($product_det->PdtProductCode)? $product_det->PdtProductCode :''}}" name="PdtProductCode" placeholder="Enter Product Code" class="span11"  required>
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <textarea class="span11" rows="7" name="PdtDescription">{{isset($product_det->PdtDescription)? $product_det->PdtDescription :''}}
                  </textarea>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <input type="text"   value="{{isset($product_det->PdtPrice)? $product_det->PdtPrice :''}}" name="PdtPrice"  class="span11">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <input type="text"   name="quantity" placeholder="Enter Product Qty" class="span11">
                    <span class="add-on">#</span> </div>
                </div>
              </div>
              <div class="control-group">
                <button type="submit" class="pull-right btn btn-success btn-mini">Add to Cart</button>
        ...
        <div class="">
          ...
          <div class="widget-content nopadding" >
              ...
              <tbody>
                ...
                <td class="taskOptions">{{$sales->product_code}}</td>
                  ...
                  <?php $total_amount = $total_amount+$sales->sales_price * $sales->quantity ?></td>
                    ...
                    <a href="{{url("delete-sales/$sales->id") }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="icon-remove"></i></a>
           ...
           <br>
            ...
            <form action="{{url('/generate_bill')}}" method="post" class="form-horizontal pull-center" style="padding-top:5px;">
                  <input type="hidden" name="_token" value="{{csrf_token()}}">
          ...
          <div class="span6">
            <div class="widget-box">
              <div class="widget-title">
                ...
                <h5>  <code>Billing Address</code></h5>
              </div>
              
              <div class="widget-content ">
              <div class="control-group">
                <label class="control-label">Select Billing Address </label>
                <div class="controls ">
                  <select name="buyer_id" id="buyer_id"  class="span12" required>
                      <option selected="selected">Select Billing Address</option>
                ...
                <div class="col-md-6" ng-controller="TodoCtrl">
                                          ...
                                          <div class="control-group">
                                            ...
                                            <div class="controls">
                                              ...
                                              <input type="text"  class="form-control input-sm span7" name="paid_amount" required>
                                            </div>
