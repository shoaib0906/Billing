...
<div id="myModal" class="modal hide">
              <div class="modal-header">
                ...
                <h3>Create New Product Group</h3>
              </div>
            ...
            <div class="">
                <div class="">
                  ...
                  <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="{{url('/post_product_group')}}">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                      <div class="control-group">
                        <label class="control-label">Group ID</label>
                        <div class="controls">
                          <input type="text" placeholder="Enter Group ID" name="groupid" class="span11 tip" required>
                        </div>
                      </div>
                      <div class="control-group">
                        <label class="control-label">Group Name</label>
                        <div class="controls">
                          <input type="text" placeholder="Enter Group Name" name="group_name" class="span11 tip" required>
                        </div>
                      </div>
                      <div class="control-group">
                        <label class="control-label">Active</label>
                        <div class="controls">
                          <select name="PgpActive" required>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeU">
                <td class="taskOptions">{{$group->PgpGroupId}}</td>
                  <td class="taskOptions">{{$group->PgpGroupName}}</td>
                   <td class="taskOptions">{{$group->PgpCompanyID}}</td>
                  <td class="taskOptions">@if($group->PgpActive =='Y')
                      Yes
                      @else
                      No
                      @endif
                    ...
                    <a href="{{url("delete-group/$group->PgpGroupId") }}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="icon-remove"></i></a>
