...
<div id="content">
   ...
   <div id="content-header">
        ...
        <a href="#"> <i class="icon-cog"></i>Purchase</a>
        <a href="{{'/group'}}" class="current"> List</a>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeU">
                <td class="taskOptions">{{$purchase_list->id}}</td>
                  <td class="taskOptions">{{$purchase_list->sup_invoice_no}}</td>
                  <td class="taskOptions">{{$purchase_list->SupSupplierName}}</td>
                  <td class="taskOptions">{{$purchase_list->vat}}</td>
                  <td class="taskOptions">{{$purchase_list->less}}</td>
                  <td class="taskOptions">{{$purchase_list->net_amout}}</td>
                  <td class="taskOptions">{{$purchase_list->paid_amount}}</td>
                  <td class="taskOptions">
                  @if($purchase_list->paid_amount == $purchase_list->net_amout )
                  ...
                  @endif
                    ...
                    <a href="{{url("view_invoice/$purchase_list->sup_invoice_no") }}" ><i class="icon-eye-open"></i></a>
