...

{
            ...
            foreach($employee->roles as $role)
              ...
              $designation = $employee->Designation;
          		$alias_data = $employee->Alias;
        			$tenants_name=DB::table('departments')->select('department_name')->where('id','=',$employee->property_id)->first();
  	          //dd($tenants_name);
              $col_data[] = array(
  ...
  public function update(Request $request, User $employee){
      ...
      if(!Entrust::can('edit_employee') || (!Entrust::can('manage_all_employee') && Entrust::can('manage_subordinate') && !Helper::isChild($employee->designation_id) ))
        ...
        $employee->designation_id = $request->input('designation_id');
		    ...
		    $employee->cell_no=$request->input('cell_no');
  ...
  public function changePassword(){
      ...
      return view('erp.change_password');
...

  {
    ...
    $this->validate($request, [
        ...
        $user->save();
        Session::flash('success','Password Changed Success');
