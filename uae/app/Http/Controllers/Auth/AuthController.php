...
class AuthController extends Controller
{
    ...
    */
    ...
    {
        $this->middleware('guest', ['except' => ['getLogout','getSingin','getRegister','postRegister','authenticate','getLogin']]);
    }
    ...
    public function getSingin()
    {
        ...
        if(!empty($data)){
            ...
            return view('auth.login1')->with('data',$data);
        }
    }
    ...
    public function postRegister(RegisterRequest $request, User $user){
		...
		$user->emp_type = 3;//3 for user 2 for administrator
